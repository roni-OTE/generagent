    ...
    <>
      ...
      <main className="max-w-[900px] mx-auto px-6 py-10 flex-1">
        <div className="mb-7">
          ...
          <h1 className="text-[28px] font-bold tracking-[-0.02em]">Standups שבועיים</h1>
          <p className="text-[var(--fg-dim)] text-[14px] mt-2">פגישות הצוות כל 48 שעות. נשמרות ב-DB ונשלחות במייל.</p>
        </div>

        {(!standups || standups.length === 0) ? (
          <div className="text-center py-14 bg-[var(--bg-elev)] border border-[var(--border)] rounded-[16px]">
            <div className="text-[14px] text-[var(--fg-dim)]">עדיין אין standups. הראשון יופעל בR/G/ה ב-09:00.</div>
          </div>
        ) : (
