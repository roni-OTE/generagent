...
function renderMarkdown(args: {
  ...
  if (m.intro_message_he) {
    sections.push(
      [
        "כשהמשתמש פותח אותך לראשונה (או אחרי שיוצרת אותך עכשיו), **לפני שהוא מבקש משהו** — שלח לו את הודעת ההיכרות הבאה בעברית, כמו שהיא:",
        "",
        "```",
        m.intro_message_he,
        "```",
    ...
    sections.push(
      [
        "כשהמשתמש פותח אותך לראשונה (או אחרי שיוצרת אותך עכשיו), **לפני שהוא מבקש משהו** — פתח בהצגה עצמית בעברית.",
        "",
        "ההודעה צריכה לכלול:",
        `1. **הצגה עצמית** — "היי, אני ${name}. ${description ?? ""}"`,
        "2. **מה אני יודע לעשות** — משפט אחד שמסכם את היכולות שלך",
        "3. **3 הצעות קונקרטיות** — דברים שהמשתמש יכול לבקש ממך עכשיו כדי להתחיל",
        "4. **שורה מזמינה** בסוף — \"במה אפשר לעזור?\"",
        "",
        "**אל תחכה שיבקש.** תפנה אליו מיד אחרי שאתה נטען.",
      ].join("\n")
    );
