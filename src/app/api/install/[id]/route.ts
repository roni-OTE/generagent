...
function renderMarkdown(args: {
  ...
  // Greeting block — first thing the agent should send in conversation
  if (m.intro_message_he) {
    sections.push("## הודעת היכרות (השלח כשאתה מתחיל שיחה ראשונה)\n");
    sections.push(m.intro_message_he);
  }
